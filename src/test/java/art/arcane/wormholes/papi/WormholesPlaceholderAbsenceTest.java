...
class WormholesPlaceholderAbsenceTest {
  private static final String[] LOADS_WITHOUT_PLACEHOLDER_API = {
      "art.arcane.wormholes.papi.WormholesPlaceholders",
      "art.arcane.volmlib.util.bukkit.papi.PlaceholderRegistration"
  };

  private static final String[] REQUIRES_PLACEHOLDER_API = {
      "art.arcane.wormholes.papi.WormholesPlaceholderInstaller",
      "art.arcane.wormholes.papi.WormholesPlaceholderExpansion"
  };
