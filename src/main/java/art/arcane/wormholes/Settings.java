...
public final class Settings {
    ...
    public static volatile double PROJECTION_OCCLUSION_REVEAL_MARGIN_DEGREES = 1.0D;
    ...
    public static void refresh(WormholesSettings src) {
        ...
        PROJECTION_OCCLUSION_REVEAL_MARGIN_DEGREES = clampDouble(
            projection.occlusionRevealMarginDegrees, 0.0D, 15.0D);
